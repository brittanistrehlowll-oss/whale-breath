// ============================================================================
// dsh-jingxi ◊ V1.0.3 browser half — DSH Native Breath（Pure Breath 直达）
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.jx-curve-empty{display:grid;align-content:center;justify-items:center;min-height:82px;gap:5px;grid-column:1/-1;justify-self:center;text-align:center;max-width:52ch;padding:0 max(24px,12%);color:var(--dsw-alias-label-secondary,currentColor);}',

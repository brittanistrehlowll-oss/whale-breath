// ============================================================================
// dsh-jingxi ◊ V1.0.4 browser half — DSH Native Breath（Pure Breath 直达）
...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    const CSS = [
      ...
      '.jx-fc-btn{width:36px;height:36px;min-width:36px;display:inline-flex;align-items:center;justify-content:center;border:0;background:transparent;color:var(--dsw-alias-label-primary,currentColor);cursor:pointer;padding:8px;border-radius:12px;font:inherit;transition:background 150ms ease,color 150ms ease;}',
      ...
      '@keyframes jx-dot-breathe{0%,100%{opacity:.55;}50%{opacity:1;}}',
      ...
      '.jx-header-fact__label{font-size:11px;line-height:16px;color:var(--dsw-alias-label-tertiary,currentColor);white-space:nowrap;}',
      ...
      '.jx-header-fact[data-state="waiting"] .jx-header-fact__value{font-size:12px;font-weight:500;color:var(--dsw-alias-label-tertiary,currentColor);}',
      ...
      '.jx-curve-empty{display:grid;align-content:center;justify-items:center;min-height:82px;gap:6px;grid-column:1/-1;justify-self:center;text-align:center;max-width:52ch;padding:0 max(24px,12%);color:var(--dsw-alias-label-secondary,currentColor);}',
      ...
      '.jx-curve-empty .jx-mark{color:var(--dsw-alias-label-tertiary,currentColor);margin-bottom:2px;}',
      ...
      '.jx-session-readout__metric{display:inline-flex;align-items:baseline;min-width:0;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}',
      ...
      '.jx-session-lane__marker[data-kind="model"]{background:color-mix(in srgb,var(--dsw-alias-brand-primary,currentColor)) 60%,var(--dsw-alias-state-error-secondary,var(--dsw-alias-label-secondary,currentColor)));}',
      ...
      '.jx-breath-surface .jx-curve-head{margin-bottom:8px;font-size:12px;color:var(--dsw-alias-label-secondary,currentColor);}',
      '.jx-breath-surface .jx-curve-label{font-size:13px;font-weight:600;color:var(--dsw-alias-label-primary,currentColor);}',
      '.jx-curve-source{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:16px;color:var(--dsw-alias-label-secondary,currentColor);font-variant-numeric:tabular-nums;}',
      ...
      '.jx-curve-event-ticks{position:absolute;inset:0;pointer-events:none;}',
       '.jx-curve-event-tick{position:absolute;top:4px;bottom:4px;width:1px;background:color-mix(in srgb,var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor)) 28%,transparent);opacity:.75;}',
       '.jx-curve-event-tick::before{content:"";position:absolute;top:0;left:-2px;width:5px;height:5px;border-radius:50%;background:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
       ...
       '.jx-curve-event-tick[data-event-kind="tool"]{background:color-mix(in srgb,var(--dsw-alias-state-warn-primary,var(--dsw-alias-brand-primary,currentColor)) 32%,transparent);}',
       '.jx-curve-event-tick[data-event-kind="tool"] .jx-curve-event-tick__dot{background:var(--dsw-alias-state-warn-primary,var(--dsw-alias-brand-primary,currentColor));}',
       '.jx-curve-event-tick[data-event-kind="tool"]::before{background:var(--dsw-alias-state-warn-primary,var(--dsw-alias-brand-primary,currentColor));}',
       '.jx-curve-event-tick[data-event-kind="retry"]{background:color-mix(in srgb,var(--dsw-alias-state-error-primary,var(--dsw-alias-brand-primary,currentColor)) 32%,transparent);}',
       '.jx-curve-event-tick[data-event-kind="retry"]::before{background:var(--dsw-alias-state-error-primary,var(--dsw-alias-brand-primary,currentColor));}',
       '.jx-curve-event-tick[data-event-kind="compaction"]{background:color-mix(in srgb,var(--dsw-alias-state-error-primary,var(--dsw-alias-brand-primary,currentColor)) 32%,transparent);}',
       '.jx-curve-event-tick[data-event-kind="compaction"]::before{background:var(--dsw-alias-state-error-primary,var(--dsw-alias-brand-primary,currentColor));}',
      ...
      '.jx-curve-legend__swatch{display:inline-block;width:8px;height:8px;border-radius:50%;background:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
      ...
      '.jx-breath-surface .jx-curve[data-curve-state="empty"] .jx-curve-legend{color:var(--dsw-alias-label-tertiary,currentColor);}',
      '.jx-breath-surface .jx-curve[data-curve-state="empty"] .jx-curve-legend__swatch{background:transparent;border:1px solid currentColor;box-sizing:border-box;}',
      ...
      '.jx-breath-surface .jx-curve-plot .jx-curve-svg{position:absolute;z-index:1;inset:0 0 auto;width:100%;height:128px;color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
      '.jx-curve-area{opacity:.12;}',
      '.jx-curve-line{color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
      '.jx-curve-event-tick{background:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
      '.jx-curve-plot .jx-curve-event-ticks{z-index:2;left:0;right:0;top:0;bottom:38px;}',
      '.jx-curve-cursor{position:absolute;z-index:3;top:0;bottom:38px;width:1px;border-left:1px dashed var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));font-size:10px;line-height:14px;white-space:nowrap;color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));transform:translateX(-50%);}',
      ...
      '.jx-breath-surface .jx-curve[data-curve-state="empty"] .jx-curve-grid{min-height:128px;background:none;border-top:1px solid var(--dsw-alias-border-l2,transparent);border-bottom:1px solid var(--dsw-alias-border-l2,transparent);grid-template-columns:minmax(0,1fr);}',
      ...
      '.jx-dialog-close:focus-visible,.jx-fc-btn:focus-visible{outline:2px solid var(--dsw-alias-focus-ring,currentColor);outline-offset:2px;}',
      '.jx-breath-detail__summary:focus-visible,.jx-fold__summary:focus-visible,.jx-phase-story__summary:focus-visible{outline:2px solid var(--dsw-alias-focus-ring,currentColor);outline-offset:2px;border-radius:4px;}',
      ...
      '.jx-breath-native .jx-header{align-items:flex-start;flex:0 0 auto;padding:16px 18px 12px;border-bottom:1px solid var(--dsw-alias-border-l2,transparent);}',
       '.jx-breath-native .jx-title-lockup{flex:1 0 auto;align-items:flex-start;gap:10px;}',

       '.jx-breath-native .jx-title{font-size:20px;line-height:28px;font-weight:600;letter-spacing:-.015em;white-space:nowrap;}',
      ...
      '.jx-breath-native .jx-quota-title__note[data-freshness="stale"]{color:var(--dsw-alias-label-tertiary,currentColor);}',
       ...
       '.jx-breath-native .jx-primary strong{font-size:32px;line-height:34px;color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,var(--dsw-alias-label-primary,currentColor)));}',
       ...
       '.jx-breath-native .jx-curve{border:1px solid var(--dsw-alias-border-l2,transparent);border-radius:12px;padding:12px;background:var(--dsw-alias-bg-layer-1,transparent);}',
       ...
       '.jx-phase-story__heading strong{font-size:14px;line-height:20px;font-weight:600;color:var(--dsw-alias-label-primary,currentColor);}',
       ...
       '.jx-phase-story__card{position:relative;min-width:0;min-height:96px;padding:10px;border:1px solid var(--dsw-alias-border-l2,transparent);border-radius:8px;background:var(--dsw-alias-bg-layer-2,var(--dsw-alias-bg-layer-1,transparent));}',
       ...
       '.jx-phase-story__card[data-tone="blue"] .jx-phase-story__dot{background:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));}',
       ...
       '.jx-trajectory-now{position:absolute;z-index:4;top:-3px;bottom:-3px;width:1px;border-left:1px dashed var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));color:var(--dsw-alias-brand-primary,var(--dsw-alias-state-business-primary,currentColor));font-style:normal;pointer-events:none;}',
      ...
      '.jx-trajectory-axis__track>.jx-trajectory-now[data-state="complete"]{top:-20px;color:var(--dsw-alias-label-tertiary,currentColor);border-left-color:var(--dsw-alias-label-tertiary,currentColor);transform:translateX(-100%);padding-right:4px;text-align:right;}',
       ...
       '.jx-phase-story__title{flex:0 0 auto;font-size:13px;line-height:18px;font-weight:600;color:var(--dsw-alias-label-primary,currentColor);white-space:nowrap;}',
...
'.jx-subagent-dock{display:flex;align-items:baseline;gap:8px;min-width:0;margin-top:4px;padding:6px 0;font-size:11px;line-height:16px;color:var(--dsw-alias-label-tertiary,currentColor);}',
        ...
        '.jx-fact__lockup{display:flex;align-items:flex-start;gap:8px;min-width:0;}',
        ...
        '.jx-fact__value-lockup{display:flex;align-items:baseline;gap:4px;min-width:0;font-variant-numeric:tabular-nums;}',
        ...
        '.jx-fact__meta{min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap;font-size:11px;line-height:15px;color:var(--dsw-alias-label-secondary,currentColor);}',
        '.jx-fact[data-empty="true"] .jx-fact__value{color:var(--dsw-alias-label-tertiary,currentColor);font-weight:500;}',
        ...
        '.jx-breath-detail{min-width:0;margin-top:8px;border-top:0;padding-top:2px;}',
        ...
        '.jx-breath-detail__summary:hover,.jx-fold__summary:hover,.jx-phase-story__summary:hover{color:var(--dsw-alias-label-primary,currentColor);}',
...
'@container jingxi-surface (max-width:560px){.jx-summary-grid{gap:2px 8px;}}',
        '@container jingxi-surface (max-width:560px){.jx-breath-facts{grid-template-columns:repeat(3,minmax(0,1fr));}}',
        ...
        '@media (prefers-reduced-motion: reduce){.jx-breath-surface{scroll-behavior:auto;}.jx-spouts{transition:none;transform:none;}.jx-fc-status__dot[data-state="active"]{animation:none;}.jx-progress-card__fill{transition:none;}}',
      ...
      h('header', { className: 'jx-header' },
        ...
        stats && stats.length > 0
          ? h('div', { className: 'jx-header-facts', 'aria-label': '头部实时指标' },
              stats.map((stat) => h('div', { key: stat.key, className: 'jx-header-fact', 'data-header-fact': stat.key, ...(stat.quality ? { 'data-quality': stat.quality } : {}), ...(stat.state ? { 'data-state': stat.state } : {}) },
        ...
        h('div', { className: 'jx-dialog-actions' },
          autoRefresh ? h(Button, {
            ...
            title: autoRefresh.disabled ? '会话已结束，自动刷新不可用' : '每 5 秒自动刷新',
          ...
          autoRefresh && autoRefresh.on && !autoRefresh.disabled
            ? h('span', { className: 'jx-dialog-auto-refresh__note', 'aria-hidden': 'true' }, `自动刷新 · ${Math.max(1, autoRefresh.countdown ?? 5)}s`)
            : null,
          actions,
    ...
    const trajectorySourceLabel = (data, trajectory, spark, view) => {
      ...
      if (points > 0) sourceParts.push(`${points} 点`)
      if (trajectory) sourceParts.push(`${segments} 段`)
    ...
    const CurveLegend = ({ eventTicks, scope = 'turn' }) => {
      ...
      const items = [
        { kind: 'rate', label: '速度' },
        { kind: 'tool', label: sessionScoped ? `工具事件 ${toolCount}` : `工具调用 ${toolCount}` },
        { kind: 'issue', label: `异常 / 重试 ${issueCount}` },
      ]
    ...
    const eventRailCopy = (view) => {
      if (view?.live) return { state: 'working', label: '进行中', detail: `第 ${view.live.openStep || 1} 步` }
    ...
    const SubagentDock = ({ view }) => {
      ...
      if (agents.length > 0) {
        ...
        return h('section', { className: 'jx-subagent-dock', 'aria-label': '子代理', 'data-state': 'populated' },
          h('span', { className: 'jx-subagent-dock__label' }, `子代理 ${agents.length} 个`),
          h('ul', { className: 'jx-subagent-dock__list' }, itemNodes),
        )
      }
      return h('section', { className: 'jx-subagent-dock', 'aria-label': '子代理', 'data-state': 'empty' },
        h('span', { className: 'jx-subagent-dock__label' }, '子代理'),
        h('span', { className: 'jx-subagent-dock__empty' }, '暂无调用'),
      )
    }
    ...
    const BreathProgressCard = ({ sessionSummary, view }) => {
      ...
      //（那会永远 100% 欺骗读屏器）。无真实进度来源时：live 显示「进行中」、否则显示「累计 N 轮」，
      // 不画 pct 进度条（诚实披露）。
      ...
      return h('section', { className: 'jx-progress-card', 'aria-label': '进度与流程' },
        h('div', { className: 'jx-progress-card__summary' },
          h('span', { className: 'jx-progress-card__text' }, roundsTotal !== undefined ? (live ? '进行中 · 累计 ' + roundsTotal + ' 轮' : '累计 ' + roundsTotal + ' 轮') : '暂无轮次数据'),
    ...
    const curveEmptyCopy = (hasTurn, trajectorySource, noEvents) => {
      if (noEvents) return { title: '当前会话暂无可绘制事件', detail: '当前会话没有工具或异常事件；完成一次调用后在此绘制。' }
      if (trajectorySource === 'session') return { title: '速度采样不足', detail: '当前会话的真实采样太少，暂不绘制；点击刷新重新抓取。' }
      if (hasTurn) return { title: '速度采样不足', detail: '本轮采样不足；下一轮产生更多采样后绘制曲线。' }
      return { title: '等待第一轮', detail: '开始一次 AI 调用后，这里将绘制呼吸曲线。' }
    }
    const BreathEmptyState = ({ hasTurn = false, trajectorySource = 'turn', noEvents = false, error, onRefresh }) => {
      ...
      return h('div', { className: 'jx-curve-empty', 'data-state': hasTurn ? 'insufficient' : 'waiting', 'aria-live': 'polite', role: 'status' },
        h(JingxiMark, { size: 28, state: 'idle' }),
    ...
    const BreathSessionSummary = ({ sessionSummary, last, trajectory }) => {
      ...
      return h('details', { className: 'jx-fold jx-fold--summary', 'aria-label': '完整会话摘要' },
        h('summary', { className: 'jx-fold__summary' },
          h('span', { className: 'jx-fold__title' }, '会话摘要'),
    ...
    const BreathSurface = () => {
      ...
      const speedValue = speed ? `${speed.label} ${speed.value}` : '等待数据'
      ...
      const retryCancelMeta = errorRetryCount !== undefined
        ? `重试 ${errorTicks.filter((t) => t.kind === 'retry').length} · 压缩 ${errorTicks.filter((t) => t.kind === 'compaction').length}`
        : '—'
      ...
      const runIdMeta = view && view.sessionId ? `运行 ${String(view.sessionId).slice(0, 8)}` : '暂无'
      ...
      const headerFreshness = freshness || '等待下一轮'
      ...
      return h('div', { className: 'jx-breath-surface jx-breath-native' },
        h(JingxiDialogHeader, {
          ...
          subtitle: [
            h('span', { className: 'jx-breath-subtitle__status' }, `${headerStatus.replace(/^线程状态：/, '')} · ${headerFreshness}${refreshing ? ' · 更新中' : ''}`),
          ],
          subtitleProps: {
          ...
          stats: [
            {
              ...
              meta: speed ? speedMeta : '等待数据',
              value: speed ? `${speed.value} tok/s` : '—',
              state: speed ? speed.state : 'waiting',
        ...
        h('div', { className: 'jx-breath-body' },
         h('div', { className: 'jx-breath-facts', role: 'group', 'aria-label': '运行核心指标' },
           ...
           h(BreathFactItem, { metric: 'rounds', label: '轮次 · 步数', value: summary.rounds !== undefined ? summary.rounds + ' 轮' : '—', meta: summary.steps !== undefined ? summary.steps + ' 步' : '暂无', icon: h(IconRefreshOutline16, { size: 18 }) }),
           h(BreathFactItem, { metric: 'tokens', label: 'Token 总量', value: summary.inputTokens !== undefined && summary.outputTokens !== undefined ? fmtTokCompact(Number(summary.inputTokens) + Number(summary.outputTokens)) : '—', meta: summary.inputTokens !== undefined ? `输入 ${fmtTokCompact(Number(summary.inputTokens))} / 输出 ${fmtTokCompact(Number(summary.outputTokens))}` : '暂无', icon: h(IconRightUpOutline16, { size: 18 }) }),
           h(BreathFactItem, { metric: 'tools', label: '工具调用', value: toolCount !== undefined ? `${toolCount} 次` : '—', meta: turnToolDurationMs !== undefined ? `本轮 ${fmtSessionDuration(turnToolDurationMs)}` : '—', icon: h(IconSettingsOutline16, { size: 18 }) }),
        ...
        h('div', { className: 'jx-breath-reading' },
          h('section', {
            ...
            h('div', { className: 'jx-curve-head' },
              h('span', { className: 'jx-curve-label' }, plotSource.kind === 'session' ? '呼吸曲线' : 'Breath Curve'),
              h('span', {
          ...
          h(EventRail, { view, freshness: data?.stale && !live ? freshness : undefined, extra: (summary && summary.rounds !== undefined ? '累计 ' + summary.rounds + ' 轮' : undefined) }),
        ),
        ...
        h(BreathProgressCard, { sessionSummary, view }),
            h('div', { className: 'jx-breath-folds', 'aria-label': '详细数据与操作' },
              h('div', { className: 'jx-recent', 'aria-label': '最近 5 轮 / Recent 5', role: 'list' },
                h('details', { className: 'jx-recent__fold' },
                  h('summary', { className: 'jx-recent__summary' },
                    h('span', { className: 'jx-recent__label' }, '最近 5 轮'),
                  ),
              h('div', { className: 'jx-recent-rows' },
                recent.length > 0
                  ...
                  : h('div', { className: 'jx-recent-empty' }, '暂无已完成轮次'),
              ),
            ),
          ),
    ...
    const JingxiWideStatus = ({ view, stale = false }) => {
      ...
      return h('div', { className: 'jx-fc-status-block' },
        ...
        turnSteps.scope === 'unavailable'
          ? h('div', { className: 'jx-fc-status-wait' }, '等待下一轮')
          : null,
          ...
          h(Button, {
            ...
            entryState === 'failed'
              ...
              : h('span', { className: 'jx-fc-entry__rate', role: 'status', 'aria-live': 'polite', 'aria-atomic': 'true', 'data-state': speed ? speed.state : 'waiting', ...(threadStale && speed ? { 'data-stale': 'true', title: staleTitle } : {}) },
                ...
                h('span', { className: 'jx-fc-entry__rate-value' }, speed ? `${speed.value} tok/s${threadStale ? ' · 数据较旧' : ''}` : '等待数据'),
              ),
          ),
